...
def main():
    ...
    ckpt_dir         = Path(__file__).parent.parent / "checkpoints_ppo"
    ...
    if latest_path.exists():
        ...
        np.random.set_state(('MT19937', ckpt["rng_numpy_arr"].cpu().numpy().astype(np.uint32),
    ...
    for batch_idx in range(start_batch, num_batches):
        ...
        if global_episode - last_ckpt_episode >= 1000:
            ...
            ckpt = {
                ...
                "rng_numpy_arr":        torch.from_numpy(_np_st[1].copy()).cpu(),
            ...
            torch.save(ckpt, ckpt_dir / f"checkpoint_ep_{global_episode}.pt")
